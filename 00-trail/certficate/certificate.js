...
//   return svg = await fs.promises.readFile(path, "utf-8");
// }
...
const generatePDF = async (user) => {
  ...
  //3rd
  // const svg = await getSvg("images/bb_stamp.svg");
  //const svg = await fs.promises.readFile("images/bb_stamp.svg", "utf-8");
  // SVGtoPDF(doc, await getSvg("images/director_sign.svg"), 450, 420, {});
  ...
  SVGtoPDF(doc, await fs.promises.readFile("images/iidt_stamp.svg", "utf-8"), 580, 400, {});
    ...
    {text: "has successfully completed the Internship on ",font: "Helvetica",},
    {text: `${user.domain} `,font: "Helvetica-Bold",},
    {text: "conducted by ",font: "Helvetica",},
    {text: "International Institute of Digital Technologies, ",font: "Helvetica-Bold",},
    {text: "the ",font: "Helvetica",},
    {text: "Knowledge Partner, Blackbuck Engineers ",font: "Helvetica-Bold",},
    {text: "and ",font: "Helvetica",},
    {text: "Andhra Pradesh State Council of Higher Education (APSCHE).",font: "Helvetica-Bold",},
    {text: "His/her performance in the Internship is ",font: "Helvetica",newLine: true,},
...
generatePDF(user).then(path => console.log(path));

//   ---- THIS won't WORK-------
// console.log(generatePDF(user));
// const ans = await generatePDF(user);
// console.log(ans);